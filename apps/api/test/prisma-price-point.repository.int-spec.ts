...
describe('PrismaPricePointRepository (integration)', () => {
  ...
  it('appends price points and lists them by crop, most recent first', async () => {
    await repo.save({ id: 'pp-int-1', cropId: 'c-int-1', form: 'GRAIN', market: 'Dantokpa', periodStart: '2026-05-01', periodEnd: '2026-05-01', price: 300, unit: 'FCFA/kg', currency: 'XOF' });
    await repo.save({ id: 'pp-int-2', cropId: 'c-int-1', form: 'GRAIN', market: 'Dantokpa', periodStart: '2026-06-01', periodEnd: '2026-06-01', price: 350, unit: 'FCFA/kg', currency: 'XOF' });
