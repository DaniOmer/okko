...
async function seedComplete(events: InMemoryCropEventStore, cropId: string, { includeVariety = true } = {}): Promise<void> {
  ...
  const sectionEvents: CropEvent[] = [
    ...
    { type: 'PricePointAdded', price: { id: `pp-seed-${cropId}`, cropId, form: 'GRAIN', market: 'Local', periodStart: '2026-01-01', periodEnd: '2026-01-01', price: 100, unit: 'FCFA/kg', currency: 'XOF' } },
