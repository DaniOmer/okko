    ...
    <main className="p-8 max-w-4xl space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1">
          ...
          <IdentityEditor cropId={params.id} initial={{ name: crop.name, commonNames: crop.commonNames, scientificName: crop.scientificName, family: crop.family, cycleType: crop.cycleType, usageCategory: crop.usageCategory, description: crop.description }} />
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0 pb-3">
            ...
            <VarietyEditor cropId={params.id} diseases={pests} zones={zones} />
          </CardHeader>
          <CardContent className="space-y-1 text-sm">
            <ul>
              {crop.varieties.map((v) => (
                <li key={v.id} className="flex items-center gap-2">
                  ...
                  <VarietyEditor cropId={params.id} initial={v} diseases={pests} zones={zones} />
                </li>
              ))}
            </ul>
          </CardContent>
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0 pb-3">
            ...
            <PriceEditor cropId={params.id} commercialization={crop.commercialization ?? []} />
          </CardHeader>
          <CardContent className="space-y-1 text-sm">
            <ul className="list-disc pl-5">
              {crop.prices.map((p) => (
